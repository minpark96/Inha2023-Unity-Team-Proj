...
namespace Photon.Pun.Demo.PunBasics
{
    ...
    public class CameraWork : MonoBehaviour
    {
        ...
        void Follow()
        {
            ...
            _cameraTransform.position = Vector3.Lerp(_cameraTransform.position, this.transform.position + this.transform.TransformVector(_cameraOffset), _smoothSpeed * Time.deltaTime);
